...
import com.example.fragmentos1.fragmentos.NavegadorFragment
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnFragmento2.setOnClickListener {
            supportFragmentManager.beginTransaction()
                .replace(R.id.contenedor,SegundoFragment.newInstance("mcdkjs","jdbkjbv"))
                .commitNow()
        }

        btnFragmento1.setOnClickListener {
            supportFragmentManager.beginTransaction()
                .replace(R.id.contenedor,PrimerFragment.newInstance("jbdjkf","hdckj"))
                .commitNow()
        }
